package com.anhanguera.learningalgorithms;
...
public class BackPropopagation {
     ...
     */
    public void retroPropagarErroPelaRede(MultilayerPerceptron rede) {
     ...
     */
    private void retropropagarErroPelaCamadaIntermediaria(double[] conjuntoTreinamento, double[] entradaCamadaDeSaida, double gradiente, CamadaMLP camadaDeSaida, CamadaMLP camadaIntermediaria) {
     ...
     * @param camadaDeSaida Camada de saída da rede.
     */
    private void retropropagarErroPelaCamadaDeSaida(double[] entradasCamadaDeSaida, CamadaMLP camadaDeSaida) {
